...
class Habitacion(Base):
    ...
    usuario_crea = relationship("Usuario", foreign_keys=[id_usuario_crea], back_populates="habitaciones_creadas")
    usuario_edita = relationship("Usuario", foreign_keys=[id_usuario_edita], back_populates="habitaciones_editadas")
